...
export function MarketingVideoGenerator() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5000/api/marketing-video",
        {
          method: "POST",
          body: formData,
        }
  ...
  return (
    <div className="space-y-6">
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-4">
              <p className="text-sm text-slate-700">
                Hi! I'll help you create a marketing video. Please upload an
                image and describe what kind of video you'd like me to generate
                for you.
              </p>
            </CardContent>
          </Card>
      ...
      {isLoading && (
        <>
          <Loader progress={progress} text="Generating your marketing video..." />
        </>
      )}
