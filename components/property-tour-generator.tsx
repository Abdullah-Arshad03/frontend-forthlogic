    ...
    <div className="space-y-6">
          ...
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="p-4">
              <p className="text-sm text-slate-700">
                Great choice! I'll help you create a property tour video. Please
                fill in the property details below and I'll generate an
                immersive virtual tour for you.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      {isLoading && (
        <>
          <Loader
            progress={progress}
            text="Creating your property tour..."
          />
        </>
      )}
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-green-800 mb-2">
                      Property Tour Generated Successfully!
                    </h3>
                  ...
                  <Button asChild className="w-full">
                    <a
                      href={`http://localhost:5000${videoData.videoUrl}`}
